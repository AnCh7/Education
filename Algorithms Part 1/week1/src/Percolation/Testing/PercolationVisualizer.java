...
public class PercolationVisualizer {
    ...
    public static void draw(Percolation.Percolation p, int n) {
        StdDraw.clear();
        ...
        if (p.percolates()) StdDraw.text(0.75 * n, -0.025 * n, "percolates");
        else StdDraw.text(0.75 * n, -0.025 * n, "does not percolate");

    }

    public static void main(String[] args) {
        In in = new In("Data/heart25.txt");      // input file
        ...
        Percolation.Percolation p = new Percolation.Percolation(n);
        draw(p, n);
        StdDraw.show();
        StdDraw.pause(DELAY);
        while (!in.isEmpty()) {
